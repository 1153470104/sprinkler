...
class BPlusTreeScratchedTest {
    ...
    void addKey1() {
        ...
        assertEquals(1, ts.bpt().blockNum);
        System.out.println();
        ts.makeBPT(5, 5);
        assertEquals("| 2 |\n| 0 1 | 2 3 4 |", ts.bpt().printBasic());
        assertEquals(3, ts.bpt().blockNum);
    }
    /**
     * test content
    ...
    void addKey3() {
        ...
        assertEquals(9, ts.bpt().blockNum);
        System.out.println();
        ...
        assertEquals(10, ts.bpt().blockNum);
        ...
        assertEquals(12, ts.bpt().blockNum);
    }
